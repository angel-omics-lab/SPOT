...
'''
from class_proAnalyzer import SpatialOmicsAnalyzer          # later: from class_dataAnalysis import SpatialOmicsToolkit
...
spot = SpatialOmicsAnalyzer(data_path = WORKSHEET_PATH, roi_labels = JSON_PATH)
